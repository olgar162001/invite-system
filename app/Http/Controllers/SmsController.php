...
class SmsController extends Controller
{
    ...
    public function updateSettings(Request $request)
    {
        ...
        AuditHelper::log('Update SMS Settings', 'SMS Settings were updated');
    ...
    public function assignToCustomer(Request $request)
    {
        ...
        AuditHelper::log('Assign SMS Units', 'SMS Units were assigned to Customer');
    ...
    public function sendInvitation(Request $request)
    {
        ...
        AuditHelper::log('Send Invitation', 'Invitations were sent to guests');
